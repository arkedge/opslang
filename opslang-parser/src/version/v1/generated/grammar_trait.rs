...
pub trait ActionTrait<'t> {
    ...
    /// Semantic action for non-terminal 'CastExpr'
    fn cast_expr(&mut self, _arg: &CastExpr<'t>) -> Result<()> {
        Ok(())
    }
    ...
    /// Semantic action for non-terminal 'SelectExpr'
    fn select_expr(&mut self, _arg: &SelectExpr<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'SelectScope'
    fn select_scope(&mut self, _arg: &SelectScope<'t>) -> Result<()> {
        Ok(())
    }

    /// Semantic action for non-terminal 'SelectScopeContent'
    fn select_scope_content(&mut self, _arg: &SelectScopeContent<'t>) -> Result<()> {
        Ok(())
    }
...
///
/// `AtomicExpr: SelectExpr;`
///
#[allow(dead_code)]
#[derive(Builder, Debug, Clone)]
#[builder(crate = "parol_runtime::derive_builder")]
pub struct AtomicExprSelectExpr<'t> {
    pub select_expr: Box<SelectExpr<'t>>,
}
...
pub enum AtomicExpr<'t> {
    ...
    SelectExpr(AtomicExprSelectExpr<'t>),
}
...
///
/// Type derived for non-terminal CastExpr
///
#[allow(dead_code)]
#[derive(Builder, Debug, Clone)]
#[builder(crate = "parol_runtime::derive_builder")]
pub struct CastExpr<'t> {
    ...
    pub cast_expr_opt: Option<CastExprOpt<'t>>,
}

///
/// Type derived for non-terminal CastExprOpt
///
#[allow(dead_code)]
#[derive(Builder, Debug, Clone)]
#[builder(crate = "parol_runtime::derive_builder")]
pub struct CastExprOpt<'t> {
    pub r#as: Token<'t>, /* as */
    pub path: Box<Path<'t>>,
}
...
///
/// Type derived for non-terminal SelectExpr
///
#[allow(dead_code)]
#[derive(Builder, Debug, Clone)]
#[builder(crate = "parol_runtime::derive_builder")]
pub struct SelectExpr<'t> {
    pub select: Token<'t>,  /* select */
    pub l_brace: Token<'t>, /* { */
    pub select_scope: Box<SelectScope<'t>>,
    pub r_brace: Token<'t>, /* } */
}

///
/// Type derived for non-terminal SelectScope
///
#[allow(dead_code)]
#[derive(Builder, Debug, Clone)]
#[builder(crate = "parol_runtime::derive_builder")]
pub struct SelectScope<'t> {
    pub select_scope_content: Box<SelectScopeContent<'t>>,
    pub select_scope_opt: Option<SelectScopeOpt<'t>>,
}

///
/// Type derived for non-terminal SelectScopeContent
///
#[allow(dead_code)]
#[derive(Builder, Debug, Clone)]
#[builder(crate = "parol_runtime::derive_builder")]
pub struct SelectScopeContent<'t> {
    pub expr: Box<Expr<'t>>,
    pub equ_g_t: Token<'t>, /* => */
    pub block: Box<Block<'t>>,
}
...
///
/// Type derived for non-terminal SelectScopeOpt
///
#[allow(dead_code)]
#[derive(Builder, Debug, Clone)]
#[builder(crate = "parol_runtime::derive_builder")]
pub struct SelectScopeOpt<'t> {
    pub end_of_line: Box<EndOfLine<'t>>,
    pub select_scope: Box<SelectScope<'t>>,
}
...
pub enum ASTType<'t> {
    ...
    SelectExpr(SelectExpr<'t>),
    SelectScope(SelectScope<'t>),
    SelectScopeContent(SelectScopeContent<'t>),
    SelectScopeOpt(Option<SelectScopeOpt<'t>>),
    Semi(Semi<'t>),
    SetExpr(SetExpr<'t>),
...
impl<'t, 'u> ActionAuto<'t, 'u> {
    ...
    ///
    /// `FactorExpr: FactorExprList /* Vec */ CastExpr;`
    ///
    #[parol_runtime::function_name::named]
    fn factor_expr(
        &mut self,
        _factor_expr_list: &ParseTreeType<'t>,
        _cast_expr: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let cast_expr = pop_item!(self, cast_expr, CastExpr, context);
    ...
    ///
    /// `FactorExprList /* Vec<T>::Push */: FactorExprList CastExpr FactorOp;`
    ///
    #[parol_runtime::function_name::named]
    ...
    ///
    /// `CastExpr: PrefixExpr CastExprOpt /* Option */;`
    ///
    #[parol_runtime::function_name::named]
    fn cast_expr(
        &mut self,
        _prefix_expr: &ParseTreeType<'t>,
        _cast_expr_opt: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let cast_expr_opt = pop_item!(self, cast_expr_opt, CastExprOpt, context);
        let prefix_expr = pop_item!(self, prefix_expr, PrefixExpr, context);
        let cast_expr_built = CastExpr {
            prefix_expr: Box::new(prefix_expr),
            cast_expr_opt,
        };
        // Calling user action here
        self.user_grammar.cast_expr(&cast_expr_built)?;
        self.push(ASTType::CastExpr(cast_expr_built), context);
        Ok(())
    }

    /// Semantic action for production 81:
    ///
    /// `CastExprOpt /* Option<T>::Some */: 'as' Path;`
    ///
    #[parol_runtime::function_name::named]
    fn cast_expr_opt_0(
        &mut self,
        ...
        let path = pop_item!(self, path, Path, context);
        let cast_expr_opt_0_built = CastExprOpt {
            r#as,
            path: Box::new(path),
        };
        self.push(ASTType::CastExprOpt(Some(cast_expr_opt_0_built)), context);
        Ok(())
    }

    /// Semantic action for production 82:
    ///
    /// `CastExprOpt /* Option<T>::None */: ;`
    ///
    #[parol_runtime::function_name::named]
    fn cast_expr_opt_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        self.push(ASTType::CastExprOpt(None), context);
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn atomic_expr_3(&mut self, _select_expr: &ParseTreeType<'t>) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let select_expr = pop_item!(self, select_expr, SelectExpr, context);
        let atomic_expr_3_built = AtomicExprSelectExpr {
            select_expr: Box::new(select_expr),
        };
        let atomic_expr_3_built = AtomicExpr::SelectExpr(atomic_expr_3_built);
        // Calling user action here
    ...
    fn select_expr(
        &mut self,
        select: &ParseTreeType<'t>,
        l_brace: &ParseTreeType<'t>,
        _select_scope: &ParseTreeType<'t>,
        r_brace: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let select = select.token()?.clone();
        let l_brace = l_brace.token()?.clone();
        let r_brace = r_brace.token()?.clone();
        let select_scope = pop_item!(self, select_scope, SelectScope, context);
        let select_expr_built = SelectExpr {
            select,
            l_brace,
            select_scope: Box::new(select_scope),
            r_brace,
        };
        // Calling user action here
        self.user_grammar.select_expr(&select_expr_built)?;
        self.push(ASTType::SelectExpr(select_expr_built), context);
        Ok(())
    }

    /// Semantic action for production 109:
    ///
    /// `SelectScope: SelectScopeContent SelectScopeOpt /* Option */;`
    ///
    #[parol_runtime::function_name::named]
    fn select_scope(
        &mut self,
        _select_scope_content: &ParseTreeType<'t>,
        _select_scope_opt: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let select_scope_opt = pop_item!(self, select_scope_opt, SelectScopeOpt, context);
        let select_scope_content =
            pop_item!(self, select_scope_content, SelectScopeContent, context);
        let select_scope_built = SelectScope {
            select_scope_content: Box::new(select_scope_content),
            select_scope_opt,
        };
        // Calling user action here
        self.user_grammar.select_scope(&select_scope_built)?;
        self.push(ASTType::SelectScope(select_scope_built), context);
        Ok(())
    }

    /// Semantic action for production 110:
    ///
    /// `SelectScopeOpt /* Option<T>::Some */: EndOfLine SelectScope;`
    ///
    #[parol_runtime::function_name::named]
    fn select_scope_opt_0(
        &mut self,
        _end_of_line: &ParseTreeType<'t>,
        _select_scope: &ParseTreeType<'t>,
    ) -> Result<()> {
        ...
        let select_scope = pop_item!(self, select_scope, SelectScope, context);
        let end_of_line = pop_item!(self, end_of_line, EndOfLine, context);
        let select_scope_opt_0_built = SelectScopeOpt {
            end_of_line: Box::new(end_of_line),
            select_scope: Box::new(select_scope),
        };
        self.push(
            ASTType::SelectScopeOpt(Some(select_scope_opt_0_built)),
            context,
        );
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn select_scope_opt_1(&mut self) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        self.push(ASTType::SelectScopeOpt(None), context);
        Ok(())
    }
    ...
    ///
    #[parol_runtime::function_name::named]
    fn select_scope_content(
        &mut self,
        _expr: &ParseTreeType<'t>,
        equ_g_t: &ParseTreeType<'t>,
        _block: &ParseTreeType<'t>,
    ) -> Result<()> {
        let context = function_name!();
        trace!("{}", self.trace_item_stack(context));
        let equ_g_t = equ_g_t.token()?.clone();
        let block = pop_item!(self, block, Block, context);
        let expr = pop_item!(self, expr, Expr, context);
        let select_scope_content_built = SelectScopeContent {
            expr: Box::new(expr),
            equ_g_t,
            block: Box::new(block),
        };
        // Calling user action here
        self.user_grammar
            .select_scope_content(&select_scope_content_built)?;
        self.push(
            ASTType::SelectScopeContent(select_scope_content_built),
            context,
        );
        Ok(())
    }
...
impl<'t> UserActionsTrait<'t> for ActionAuto<'t, '_> {
    ...
    fn call_semantic_action_for_production_number(
        ...
        match prod_num {
            ...
            80 => self.cast_expr(&children[0], &children[1]),
            81 => self.cast_expr_opt_0(&children[0], &children[1]),
            82 => self.cast_expr_opt_1(),
            83 => self.prefix_expr_0(&children[0], &children[1]),
            ...
            98 => self.atomic_expr_0(&children[0]),
            99 => self.atomic_expr_1(&children[0]),
            100 => self.atomic_expr_2(&children[0]),
            101 => self.atomic_expr_3(&children[0]),
            ...
            110 => self.select_scope_opt_0(&children[0], &children[1]),
            111 => self.select_scope_opt_1(),
            112 => self.select_scope_content(&children[0], &children[1], &children[2]),
            113 => self.qualif_0(&children[0]),
            114 => self.qualif_1(&children[0]),
            115 => self.default_modifier(&children[0], &children[1]),
            116 => self.modifier(&children[0], &children[1], &children[2]),
            117 => self.modifier_opt_0(&children[0]),
            118 => self.modifier_opt_1(),
            119 => self.kind_arg(&children[0], &children[1]),
            120 => self.path(&children[0], &children[1]),
            121 => self.path_list_0(&children[0], &children[1], &children[2]),
            122 => self.path_list_1(),
            123 => self.ident(&children[0]),
            124 => self.literal_0(&children[0]),
            125 => self.literal_1(&children[0]),
            126 => self.literal_2(&children[0]),
            127 => self.literal_3(&children[0]),
            128 => self.literal_4(&children[0]),
            129 => self.literal_5(&children[0]),
            130 => self.array(&children[0], &children[1], &children[2]),
            131 => self.array_opt_0(&children[0]),
            132 => self.array_opt_1(),
            133 => self.comma_sep_elements(&children[0], &children[1]),
            134 => self.comma_sep_elements_opt_0(&children[0]),
            135 => self.comma_sep_elements_opt_1(),
            136 => self.comma_expr_list(&children[0], &children[1]),
            137 => self.comma_expr_list_opt_0(&children[0]),
            138 => self.comma_expr_list_opt_1(),
            139 => self.string(&children[0]),
            140 => self.byte_literal(&children[0]),
            141 => self.hex_byte_literal(&children[0]),
            142 => self.numeric_0(&children[0]),
            143 => self.numeric_1(&children[0]),
            144 => self.numeric_2(&children[0]),
            145 => self.numeric_3(&children[0]),
            146 => self.binary_integer(&children[0]),
            147 => self.octal_integer(&children[0]),
            148 => self.hexadecimal_integer(&children[0]),
            149 => self.ieee754_float(&children[0]),
            150 => self.rfc3339_date_time(&children[0]),
            151 => self.block(&children[0], &children[1], &children[2]),
