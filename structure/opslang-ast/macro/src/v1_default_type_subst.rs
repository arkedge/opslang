...
const DEFAULT_TYPES: &[(&str, &str)] = define_default_types! {
    ...
    type Exprs = &'cx [syn::Expr<'cx, Self>];
    ...
    type FilePath = syn::Literal<'cx, Self>;
    type ImportedPath = syn::Path<'cx, Self>;
