...
impl<'cx> Context<'cx> {
    ...
    /// Allocates an IR definition in the IR context.
    pub fn alloc_definition(&'cx self, definition: Definition<'cx>) -> &'cx Definition<'cx> {
        self.definition_arena.alloc(definition)
    }
